...
%res_signal1(:,1)=res_signal0(:,x1); x1,x2就是你要的通道，要几个就加几行
%res_signal1(:,2)=res_signal0(:,x2)
%加在Ytt那行前面，然后把Ytt=res_signal0(:,:)*9.8;改成Ytt=res_signal1(:,:)*9.8;
